...
const FacultyProjectCard = ({data}) => {
  console.log("datd from facultyProject card", data);
  return (
    <NavLink to="/projectlist/proj/:id">
      <div className="max-w-sm cursor-pointer overflow-hidden rounded shadow-lg hover:-mt-2 mx-2 lg:mx-0">
