...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="pr-5py-5.5 flex items-center justify-between gap-2 lg:py-6.5">
        <div className="mx-auto pr-10 text-center ">
          <NavLink to="/">
            <img
              src="/phlogo.jpg"
              ...
              alt="Logo"
            />
            <h1 className="m-auto flex text-center text-xl font-bold  text-white">
              Project Hub
            </h1>
          </NavLink>
        </div>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="px-4 lg:mt-3  lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Forms --> */}
              <SidebarLinkGroup
                activeCondition={pathname === '/se' || pathname.includes('se')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${(pathname === '/se' ||
              ...
              <SidebarLinkGroup
                activeCondition={pathname === '/te ' || pathname.includes('te')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              <SidebarLinkGroup
                activeCondition={pathname === '/fe' || pathname.includes('fe')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
