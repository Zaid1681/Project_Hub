...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  // console.log('currentUser role data', currentUser);
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="my-8 flex items-center justify-between gap-2 px-6 lg:py-6.5">
        <div className="mx-auto">
          <NavLink to="/home">
            <img
              ...
              alt="Logo"
            />
            <h1 className="mt-5 text-2xl font-bold text-white">Project Hub</h1>
          </NavLink>
        </div>
            ...
            <div>
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  <NavLink
                    to="/home"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                ...
                <SidebarLinkGroup
                  activeCondition={
                    pathname === '/se' || pathname.includes('se')
                  }
                >
                  {(handleClick, open) => {
                    return (
                      <React.Fragment>
                        <NavLink
                          to="#"
                          className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                            (pathname === '/se' ||
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  <NavLink
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                ...
                <li>
                  <NavLink
                    to="/creategroup"
                    t
                    className={`group relative flex items-center gap-1 rounded-md py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                ...
                <li>
                  <NavLink
                    to="/groupsection"
                    className={`group relative flex items-center gap-2.5 rounded-md py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 ${
                      pathname.includes('groupsection') &&
                      'bg-primary dark:bg-meta-4'
                    }`}
                  >
                    <svg
